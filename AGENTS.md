...
- `RecipeSwipe.xcodeproj` - Xcode project
- `RecipeSwipe.xcworkspace` - Xcode workspace
- `plans` - repository source or sample assets
- `RecipeSwipe` - repository source or sample assets
- `RecipeSwipeTests` - repository source or sample assets
...
- Tests: `make test`
- Build: `make build`
- Local Apple development: `open RecipeSwipe.xcworkspace`
- If a command above skips because a platform toolchain is missing, verify on a machine with that SDK before claiming platform behavior is tested.

## Coding conventions

- Language mix noted in the README: Swift (8), C/C++ headers (1).
...
- Test-related files detected: `RecipeSwipeTests/RecipeSwipeTests.swift`
